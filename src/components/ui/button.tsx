...
export default function Button({
  ...
  return (
    <button
      type={type}
      onClick={onClick}
      className={`px-6 py-2 rounded font-sans text-[14px] leading-5 transition-all active:scale-95 flex items-center justify-center gap-2 ${variantStyles[variant]} ${className}`}
    >
      {icon}
      {children}
    </button>
