      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="font-sans text-[14px] leading-5 text-on-surface-variant">
            Total active system components: 142
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button className="bg-primary text-on-primary px-6 py-2 rounded font-sans text-[14px] leading-5 self-end hover:opacity-90 transition-opacity flex items-center gap-2 h-[42px]">
