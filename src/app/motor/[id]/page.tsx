...
export default function MotorDetailPage() {
  ...
  const { node, loading: nodeLoading } = useMotorNode(motorId);
      ...
      <main className="mt-16 w-full max-w-max-width mx-auto p-margin-desktop flex flex-col gap-[24px]">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex gap-4">
            <button className="bg-surface-container-lowest border border-outline-variant text-on-surface px-6 py-2 rounded font-sans text-[14px] leading-5 hover:bg-surface-container-low transition-colors border-b-2">Calibrate</button>
