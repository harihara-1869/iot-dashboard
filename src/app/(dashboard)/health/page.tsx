...
import { useDiagnosticsLogs } from "@/lib/hooks/useSupabase";
...
export default function HealthPage() {
  const { logs, loading } = useDiagnosticsLogs();
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mb-8 rounded-xl border border-outline-variant overflow-hidden relative">
        ...
        <div className="relative glass-effect p-gutter flex items-center justify-between border-b border-outline-variant/30">
          <div className="flex items-center gap-4">
            ...
            <span className="font-mono text-[20px] leading-7 font-semibold text-secondary">SYSTEM OPERATIONAL: NOMINAL LOAD</span>
          </div>
          <div className="flex gap-8">
            <div className="text-right">
              <p className="font-mono text-[12px] leading-4 tracking-[0.05em] font-bold text-on-surface-variant">UPTIME</p>
              <p className="font-mono text-[14px] leading-5 font-medium">142:12:04:19</p>
            </div>
            <div className="text-right">
              <p className="font-mono text-[12px] leading-4 tracking-[0.05em] font-bold text-on-surface-variant">LOAD FACTOR</p>
      ...
      <DiagnosticsGrid />
      <HealthHistoryTable logs={loading ? [] : logs} />
